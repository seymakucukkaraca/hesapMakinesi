    ...
    switch (value){
        ...
        case "=":
            if(previousOperator === null){
                return;// hesaplanacak deger olmadiginda null degerini dondurur.
            }
            ...
            break;
        case "←":
            // ekranda herhangi bir sayi silindiğinde ekrana tekrardan 0 degerini dondurur.
            if(buffer.length === 1){
                buffer = "0";
            }
            //sayilari ekranda tek tek siler
            else{
